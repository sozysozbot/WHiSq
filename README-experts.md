...
This document assumes some familiarity with the concepts of microtonal music and isomorphic keyboards. If you are new to these topics, I recommend starting with the [main README](README.md) and then coming back to this document for more details. I will be using some jargons from [Xenharmonic Wiki](https://en.xen.wiki/).

## Introduction

WHiSq comes in two flavors: 
